...
if __name__ == '__main__':
    ...
    train_df = pd.read_csv('../twitter/augmented/balanced.csv', header=0)
    ...
    for o in options:
        ...
        FastTextSupervisedClassifier.df_to_FT_labels(train, f"../twitter/augmented/balanced/{o}/FT_train.txt", "class",
                                                     "tweet")
        FastTextSupervisedClassifier.df_to_FT_labels(valid_df, f"../twitter/augmented/balanced/{o}/FT_valid.txt", "class",
                                                     "tweet")


        if o != "rnn_enriched":
            FastTextSupervisedClassifier.df_to_RNNLM_labels(train, f"../twitter/augmented/balanced/{o}/RNN_train.txt",
                                                            "class", "tweet", False)
        else:
            FastTextSupervisedClassifier.df_to_RNNLM_labels(train, f"../twitter/augmented/balanced/{o}/RNN_train.txt",
        ...
        FastTextSupervisedClassifier.df_to_RNNLM_labels(valid_df, f"../twitter/augmented/balanced/{o}/RNN_valid.txt", "class", "tweet", True)

        train.to_pickle(f"../twitter/augmented/balanced/{o}/train.p")
        valid_df.to_pickle(f"../twitter/augmented/balanced/{o}/valid.p")
